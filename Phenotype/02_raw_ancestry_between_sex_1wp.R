...
write.table(p_EUR_AFR,"/data1/tmp/wangzhaobin/UKB/gyy_ukb/UKB_vol/ancestry_difference/raw/1w_p_EUR_AFR",quote=F,row.names=F)
...
write.table(p_EUR_SAS,"/data1/tmp/wangzhaobin/UKB/gyy_ukb/UKB_vol/ancestry_difference/raw/1w_p_EUR_SAS",quote=F,row.names=F)
...
write.table(p_EUR_EAS,"/data1/tmp/wangzhaobin/UKB/gyy_ukb/UKB_vol/ancestry_difference/raw/1w_p_EUR_EAS",quote=F,row.names=F)
...
write.table(p_AFR_SAS,"/data1/tmp/wangzhaobin/UKB/gyy_ukb/UKB_vol/ancestry_difference/raw/1w_p_AFR_SAS",quote=F,row.names=F)
...
write.table(p_AFR_EAS,"/data1/tmp/wangzhaobin/UKB/gyy_ukb/UKB_vol/ancestry_difference/raw/1w_p_AFR_EAS",quote=F,row.names=F)
...
write.table(p_SAS_EAS,"/data1/tmp/wangzhaobin/UKB/gyy_ukb/UKB_vol/ancestry_difference/raw/1w_p_SAS_EAS",quote=F,row.names=F)
